    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          Hallo, <?= isset($_SESSION['nama']) ? $_SESSION['nama'] : 'Admin'; ?> <i class="fas fa-user-secret"></i>
        </a>
           ...
           <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <a href="export_excel.php" class="btn btn-info btn-sm">
                    <i class="fas fa-file-excel"></i> Export Excel
                  </a>

                
                  <a href="export_pdf.php" class="btn btn-danger btn-sm" target="_blank">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                 <?php
                 $query_ambil_data = mysqli_query($db, "SELECT * FROM tb_pengguna") or die(mysqli_error($db));
                 ...
                 if ($rv > 0) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a name="btn_edit" class="btn btn-sm fas fa-edit btn-warning" href="edit_data.php?id=<?= $id ?>"><i></i></a>
    ...
    <div class="modal-content">
      ...
      <form action="proses_tambah.php" method="post">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <!-- Mengubah type="button" menjadi type="submit" agar bisa diklik dan menyimpan data -->
...
<script>
  // Script mengisi data ke Modal Edit secara otomatis
