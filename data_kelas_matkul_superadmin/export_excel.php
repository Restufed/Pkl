...
ob_start();
// buat nama file
$nama_file = "Data-kelas Mata kuliah-" . date('Y-m-d');
$query_panggil_mahsiswa=mysqli_query($db,"SELECT * FROM tb_kelas_matkul ") or die (mysqli_error($db,));


$spreadsheet = new Spreadsheet();
$sheet = $spreadsheet->getActiveSheet();
$sheet->setTitle('Data Kelas Mata Kuliah');
