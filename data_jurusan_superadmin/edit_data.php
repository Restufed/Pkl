  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6"><h1 class="m-0">Edit Data Jurusan</h1></div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?php
              $kode = $_GET['id'];
              $query_edit_jurusan = mysqli_query($db, "SELECT kode_jurusan,nama_jurusan FROM tb_jurusan WHERE kode_jurusan='$kode'") or die(mysqli_error($db));
              $data = mysqli_fetch_array($query_edit_jurusan);
              ...
              <form action="proses_edit.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="kode" class="form-control" value="<?= $kode; ?>" id="nama" placeholder="Masukan kode jurusan" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Jurusan</label>
                    <input type="text" name="nama" class="form-control" value="<?= $nama_jurusan; ?>" placeholder="Masukan Nama jurusan" required>
                  </div>
                  <!-- select -->
                </div>
                <!-- /.card-body -->
