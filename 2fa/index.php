    ...
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3> <strong>sistem menajemen</strong></h3>
            
            <form action="" method="post">
              <div class="form-group first">
                <label for="username">Pin</label>
                <input type="text" class="form-control" placeholder="masukan pin anda" id="username" name="pin" required>
              </div>
            ...
            <?php 
             if(isset($_POST["btn-2fa"])) {  // trigger button login ketika ditekan
                ...
                echo '<script>alert ("pin yang anda masukan salah, silahkan login kembali!")</script>';
